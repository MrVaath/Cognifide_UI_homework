...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderResults = exports.renderImage = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar renderImage = exports.renderImage = function renderImage(image, large) {\n  if (large) {\n    var markup = '\\n            <a class=\"gallery__image gallery__image--large\" href=\"#' + image.large_url + '\">\\n                <img src=\"' + image.url + '\" alt=\"' + image.site + '\" />\\n            </a>\\n        ';\n    _base.elements.images.insertAdjacentHTML('beforeend', markup);\n  } else {\n    var _markup = '\\n            <a class=\"gallery__image gallery__image--small\" href=\"#' + image.large_url + '\">\\n                <img src=\"' + image.url + '\" alt=\"' + image.site + '\" />\\n            </a>\\n        ';\n    _base.elements.images.insertAdjacentHTML('beforeend', _markup);\n  }\n};\n\nvar renderResults = exports.renderResults = function renderResults(images) {\n  for (var i = 0; i < 10; i++) {\n    if (i % 10 === 4 || i % 10 === 8) {\n      renderImage(images[i], true);\n    } else {\n      renderImage(images[i], false);\n    }\n  }\n};\n\n//# sourceURL=webpack:///./src/js/views/imagesView.js?");
