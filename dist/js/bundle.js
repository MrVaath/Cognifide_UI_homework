...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.renderImage = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar renderImage = exports.renderImage = function renderImage(image) {\n  var markup = '\\n    <a class=\"\" href=\"#\">\\n        <img src=\"' + image.url + '\" alt=\"' + image.site + '\" />\\n    </a>\\n    ';\n  _base.elements.images.insertAdjacentHTML('afterbegin', markup);\n};\n\n//# sourceURL=webpack:///./src/js/views/imagesView.js?");
